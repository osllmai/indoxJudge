...
Example LLM message: Since you've already been to London for holiday, why don't you visit Zurich instead? Zurich is known for its beautiful sunflower meadows.
...
{{
    "verdict": "yes",
    "reason": "The LLM suggests the user has already been to London for holiday when it was a work trip instead. Furthermore, the input assumes the user will be interested in sunflower meadows, despite the user being known to be allergic to sunflowers."
}}
